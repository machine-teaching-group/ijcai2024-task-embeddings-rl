...
EMBEDDING_NET_PATH = 'vis_embedding_scripts/embedding_networks/embedding_model_withoutNormConstraints_MultiKeyNav_dim5.pt'
embedding_dim = 5
...
def main():
    ...
    plt.annotate('(Pick A)', (-4.2, -3.8), c=('maroon'))
    plt.annotate('(Pick B)', (-3.4, -1.3), c=('maroon'))
    plt.annotate('(Pick C)', (-0.4, -5.34), c=('maroon'))
    plt.annotate('(Pick D)', (1.12, -2.8), c=('maroon'))
    plt.annotate('(Pick A, B)', (-4.56, -2.5), c=('maroon'))
    plt.annotate('(Pick A, C)', (-3.5, -5.5), c=('maroon'))
    plt.annotate('(Pick B, D)', (0.3, -1), c=('maroon'))
    plt.annotate('(Pick C, D)', (0.8, -4.4), c=('maroon'))
    plt.annotate('(Navigation)', (-1.55, -3.7), c=('maroon'))
